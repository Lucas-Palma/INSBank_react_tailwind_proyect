...
const Hero = () => (
    <section id='home' className={`flex md:flex-row flex-col sm:py-[110px] py-[90px]`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          ...
          <div className='ss:flex hidden md:mr-4 mr-0 getstarted__animation'>
            <GetStarted />
          </div>
        </div>
      ...
      <div className={`flex-1 ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className='absolute z-[0] w-[50%] h-[50%] right-20 bottom-0 blue__gradient'></div>
      </div> 
